...
const OursService = () => {
  ...
  return (
    <Box className='grid gap-12 bg-[#fffdfd]'>
      <ContainDescription className="text-center">
        <Text
          color={'#EA6F66'} 
        ...
        <Description
                  ...
                  classe={'common-description-home'} space={2}         />
      </ContainDescription>
      ...
      <Container className='grid gap-y-8 gap-x-12 grid-cols-3'>
         {tableCardService.map((el, index) => (
          <Card classe={'grid gap-3  place-items-center '} key={index}  styleCard={{width: 205,height: 150,left: 288,top: 858}}>
            {el.icon}
